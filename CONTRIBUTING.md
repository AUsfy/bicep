...
* If you haven't already, you will need [dotnet](https://dotnet.microsoft.com/download) core sdk 8.0.202 and [node + npm](https://nodejs.org/en/download/) 10 (or later) installed locally to build and run this project.
...
* You can use the following command to run most of the Bicep dotnet-based tests:
  * `dotnet test`
